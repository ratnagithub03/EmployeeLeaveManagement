    ...
    $(document).ready(function(){
        ...
        $('#voice-command').click(function(){
            ...
            recognition.onresult = function(event) {
                ...
                // Parse dates
                const dateRegex = /from ([a-zA-Z]+ \d{1,2}(?:th|st|nd|rd)?, \d{4}) to ([a-zA-Z]+ \d{1,2}(?:th|st|nd|rd)?, \d{4})/;
                ...
                // Parse reason for leave
                if (transcript.includes('reason')) {
                    const reasonIndex = transcript.indexOf('reason');
                    const reasonText = transcript.substring(reasonIndex + 7);
