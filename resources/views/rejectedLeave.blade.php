        ...
        $.ajax({
            ...
            success:function(res){
                ...
                $(res).each(function(key, value){
                    // Add red button for 'rejected' status
                    let statusButton = value.leave_status.toLowerCase() === 'rejected' 
                        ? '<button style="background-color: #dc3545; color: white; border: none; padding: 5px 10px; border-radius: 5px;">Rejected</button>' 
                        : value.leave_status;
